...
#echo"Enviar e-mail <br>";
        ...
        try {
            ...
            //Attachments - Anexos
            #$mail->addAttachment('./file/Teste.zip');         //Add attachments
            $mail->addAttachment('./file/Teste.zip', 'Teste.zip');    //Optional name
            

            //Content
            $mail->isHTML(true);                                  //Set email format to HTML
            $mail->Subject = 'Título do e-mail';
            $mail->Body = 'Conteúdo do e-mail em  <b>HTML com Anexo</b>';
